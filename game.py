...
class Game:
    ...
    def menu(self):
        ...
        created_by = small_font.render("Created by Ali Pourghasemi and Arman Kiani", True, black_color)
        ...
        self.screen.blit(created_by, 
                      ...
                      550)) # self.screen.get_height() - created_by.get_height() - 100
